...
1. **Locate the GraphQL interface URL** `https
2. **Build your structured query choosing required response fields.** - Build your structured query choosing required response fields.
3. **Dispatch query in a POST body containing the query string.** - Dispatch query in a POST body containing the query string.
...
### Q: Is GraphQL rate limited separately?
**A**: Yes, GraphQL calls are throttled using complexity scores instead of simple request numbers.
