...
1. **Obtain Webflow API Access Token from project dashboard.** - Obtain Webflow API Access Token from project dashboard.
2. **Choose dynamic collection ID.** - Choose dynamic collection ID.
3. **Map workflow data arrays to collections attributes.** - Map workflow data arrays to collections attributes.
4. **Settle sync timeline parameters.** - Settle sync timeline parameters.
...
### Q: Can I publish items live directly?
**A**: Yes, choose 'Publish Live' parameter to bypass draft collections updates.

## Related Articles

- [Notion Pages Synchronization](../integrations/notion_pages_synchronization.md)
