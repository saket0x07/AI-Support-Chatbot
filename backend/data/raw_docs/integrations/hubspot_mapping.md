...
1. **Link your Hubspot profile in Settings > Integrations.** - Link your Hubspot profile in Settings > Integrations.
2. **Access the Contact Sync configuration mapper.** - Access the Contact Sync configuration mapper.
3. **Associate custom attributes (e.g. lead status, conversion sources) with Hubspot fields.** - Associate custom attributes (e.g. lead status, conversion sources) with Hubspot fields.
4. **Perform a test contacts sync run.** - Perform a test contacts sync run.
...
### Q: Are deleted contacts removed from Hubspot?
**A**: By default, no. We apply a soft archive sync logic unless explicitly configured to delete.
