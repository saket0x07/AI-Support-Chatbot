...
1. **Go to Notion Settings > Connections and create integration credentials.** - Go to Notion Settings > Connections and create integration credentials.
2. **Share target workspace database with the integration connection.** - Share target workspace database with the integration connection.
3. **Input the Notion Integration token inside the CloudFlow integrations manager.** - Input the Notion Integration token inside the CloudFlow integrations manager.
4. **Map flow keys to database columns.** - Map flow keys to database columns.
...
### Q: Can I append texts to existing database pages?
**A**: Yes, the Notion card supports update and append block commands.

## Related Articles

- [Google Drive File Exports](../integrations/google_drive_file_exports.md)
- [Google Sheets Live Mapping](../integrations/google_sheets_live_mapping.md)
