...
1. **Add Google Drive connector inside your flow steps.** - Add Google Drive connector inside your flow steps.
2. **Approve OAuth access permissions when prompted.** - Approve OAuth access permissions when prompted.
3. **Select the destination directory folder ID.** - Select the destination directory folder ID.
4. **Configure output fields to upload generated file formats.** - Configure output fields to upload generated file formats.
...
**A**: Single file uploads to Google Drive via the integration catalog are capped at 100MB.
