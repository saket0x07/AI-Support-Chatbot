...
1. **Open Discord channel settings and select Integrations.** - Open Discord channel settings and select Integrations.
2. **Click Webhooks > New Webhook, copy the destination URL.** - Click Webhooks > New Webhook, copy the destination URL.
3. **In your flow settings, bind the Discord action card and enter the URL.** - In your flow settings, bind the Discord action card and enter the URL.
4. **Save and execute a test run.** - Save and execute a test run.
...
### Q: Can I format messages with rich embeds?
**A**: Yes, our Discord block card allows defining custom titles, footers, and border colors.
