...
1. **Open Settings > Billing settings.** - Open Settings > Billing settings.
2. **Select 'Hibernate Workspace'.** - Select 'Hibernate Workspace'.
3. **Confirm base hibernation pricing terms ($5/month).** - Confirm base hibernation pricing terms ($5/month).
4. **Save changes to transition workflow statuses to paused state.** - Save changes to transition workflow statuses to paused state.
...
### Q: How long can a workspace remain hibernated?
**A**: You can keep your workspace in hibernation mode indefinitely. Reactivation restores all scripts immediately.
