...
1. **Navigate to Settings > Plan Details.** - Navigate to Settings > Plan Details.
2. **View comparative cards table detailing seat caps, run numbers, support SLA metrics, and features.** - View comparative cards table detailing seat caps, run numbers, support SLA metrics, and features.
...
### Q: Which plan has webhook support?
**A**: Webhook integrations are supported on all tiers, but multi-endpoint configurations are limited to Professional and Enterprise tiers.

## Related Articles

- [Upgrading Subscription Plans](../subscription/upgrading_subscription_plans.md)
- [Custom Enterprise Plans](../subscription/custom_enterprise_plans.md)
