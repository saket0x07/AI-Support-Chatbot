...
1. **Navigate to Settings > Usage and Quotas.** - Navigate to Settings > Usage and Quotas.
2. **View the graphical bars displaying quotas consumed.** - View the graphical bars displaying quotas consumed.
3. **Check limits** Starter (10 flows, 1k runs/mo), Professional (unlimited flows, 50k runs/mo).
4. **Upgrade your plan if consumption values hover near 100% boundary limit.** - Upgrade your plan if consumption values hover near 100% boundary limit.
...
### Q: What happens if I cross my run limit?
**A**: Workflows will not fail immediately. We apply a soft grace buffer of 10% before runs are suspended.
