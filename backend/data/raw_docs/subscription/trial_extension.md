...
1. **Open the Support Ticketing window.** - Open the Support Ticketing window.
2. **Select 'Billing and Subscriptions' request category.** - Select 'Billing and Subscriptions' request category.
3. **Submit a message explaining your testing requirements.** - Submit a message explaining your testing requirements.
4. **The support coordinator will review your request and toggle a 7-day trial extension.** - The support coordinator will review your request and toggle a 7-day trial extension.
...
### Q: Do trial accounts require a credit card?
**A**: No, you can sign up for our 14-day trial without registering any payment cards.
