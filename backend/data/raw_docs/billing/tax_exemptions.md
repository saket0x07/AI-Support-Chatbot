...
1. **Open Billing dashboard settings.** - Open Billing dashboard settings.
2. **Click on the 'Tax Details' section.** - Click on the 'Tax Details' section.
3. **Select your country and enter your local tax registration number (e.g., VAT ID).** - Select your country and enter your local tax registration number (e.g., VAT ID).
4. **For US tax exemption, click 'Upload Certificate' and upload your tax-exempt PDF.** - For US tax exemption, click 'Upload Certificate' and upload your tax-exempt PDF.
5. **Save updates to enable automatic calculation modifications on future invoices.** - Save updates to enable automatic calculation modifications on future invoices.
...
### ⚠️ VAT ID validation failure
**Description**: Encountered when system bounds or client validations fail.
**Resolution**: Ensure your VAT ID matches VIES registry guidelines. If the ID is valid but fails, submit verification certificates to billing@cloudflow.com.

## Frequently Asked Questions

### Q: Do you refund tax paid on previous cycles?
**A**: Yes, if you submit valid tax exemption registration credentials within 30 days of invoice payment, we will credit the calculated tax back to your card.
