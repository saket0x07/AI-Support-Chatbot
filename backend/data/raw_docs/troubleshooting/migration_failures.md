...
1. **Export backup file of legacy flow schema.** - Export backup file of legacy flow schema.
2. **Perform incremental upgrades of step nodes.** - Perform incremental upgrades of step nodes.
...
### Q: Can I roll back to prior versions?
**A**: Yes, the flow version history catalog allows restoring any past save point state.

## Related Articles

- [Workspace Migration Policies](../troubleshooting/workspace_migration_policies.md)
