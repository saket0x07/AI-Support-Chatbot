...
1. **Check system logs to verify email delivery statuses.** - Check system logs to verify email delivery statuses.
2. **Confirm recipient addresses are active.** - Confirm recipient addresses are active.
...
### Q: Why did my alert fail?
**A**: Possible reasons: spam filtering, recipient address bouncing, or outbound API limit exhaustion.

## Related Articles

- [Adding Billing Contacts](../troubleshooting/adding_billing_contacts.md)
