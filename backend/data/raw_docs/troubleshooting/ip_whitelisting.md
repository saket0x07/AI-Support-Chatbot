...
1. **Obtain list of static IPs** `34.120.45.1`, `34.120.45.2`.
2. **Configure local corporate router whitelists.** - Configure local corporate router whitelists.
3. **Verify handshake connection logs.** - Verify handshake connection logs.
...
### Q: Do static IP addresses change regularly?
**A**: No, any schedule changes are sent to registered organization contacts 30 days prior to modification.

## Related Articles

- [Setting Login IP Restrictions](../troubleshooting/setting_login_ip_restrictions.md)
