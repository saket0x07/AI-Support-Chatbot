...
1. **Log in to the CloudFlow console with your primary account.** - Log in to the CloudFlow console with your primary account.
2. **Click on the organization name dropdown in the top-left section of the dashboard.** - Click on the organization name dropdown in the top-left section of the dashboard.
3. **Select 'Switch Organization' from the menu options.** - Select 'Switch Organization' from the menu options.
4. **Click on the target organization name you wish to switch into.** - Click on the target organization name you wish to switch into.
5. **If joining a new organization, click 'Join via Invitation Link' and follow the prompt.** - If joining a new organization, click 'Join via Invitation Link' and follow the prompt.
...
### ⚠️ Organization not listed in switcher dropdown
**Description**: Encountered when system bounds or client validations fail.
**Resolution**: Ensure the administrator of the destination organization has sent an invitation to your email address and that you have clicked the confirmation link.

## Frequently Asked Questions

### Q: Can I use different passwords for each organization?
**A**: No. Your email login profile is unified. Changing your password in one organization changes it for all linked profiles.

### Q: How does 2FA work when switching organizations?
**A**: MFA is tied to your login profile. You will only be prompted once at login, not when switching workspaces.
